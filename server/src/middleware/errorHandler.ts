...
const MESSAGE_CODES: Record<string, string> = {
  ...
  "Enter a name": "PERSON_NAME_REQUIRED",
  "Split not found": "SPLIT_NOT_FOUND",
  "Split shares must add up to the total": "SPLIT_SHARES_MISMATCH",
  "Split shares cannot be negative": "SPLIT_SHARES_NEGATIVE",
